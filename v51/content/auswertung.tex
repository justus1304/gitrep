...
\autoref{sec:linearverstärker}). Die Leerlaufverstärkung wird durch Mittelung der 
Werte im Plateaubereich bestimmt. Die Grenzfrequenz liegt dort an, wo die Verstärkung 
auf den Faktor $1/\sqrt{2}$ der Leerlaufverstärkung abgefallen ist. Das 
Bandbreitenprodukt ergibt sich schließlich aus dem Produkt von Leerlaufverstärkung
und Grenzfrequenz.
\begin{table}[H]
    \centering
