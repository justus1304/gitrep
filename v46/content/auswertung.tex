...
\begin{table}[H]
    ...
    \end{tabular}   
\end{table}
\noindent Für die Berechnung der effektiven Masse werden die folgenden Konstanten benötigt:
\begin{align*}
    \label{eqn:1}
...
maximale Magnetfeldstärke am Ort der Probe, lässt sich auf die effektive Masse schließen.
\begin{equation}
    \label{eqn:2}
