...
#Wärmeströme, kappa [W/ mK], A[m], delT[°C], delx[m] --> dQ[W]
#zu T1-T2
#zu 100s
...
#zu T7-T8
#zu 100s
dQ_dt21 = -50 * 0.004 * 0.012 * (34.93-22.85)/0.03
print("dQ2 nach 100s = ", dQ_dt21)
#zu 200s
dQ_dt22 = -50 * 0.004 * 0.012 * (37.37-26.37)/0.03
print("dQ2 nach 200s = ", dQ_dt22)
#zu 400s
dQ_dt23 = -50 * 0.004 * 0.012 * (39.11-30.20)/0.03
print("dQ2 nach 400s = ", dQ_dt23)
#zu 600s
dQ_dt24 = -50 * 0.004 * 0.012 * (40.60-32.59)/0.03
print("dQ2 nach 600s = ", dQ_dt24)
#zu 800
dQ_dt25 = -50 * 0.004 * 0.012 * (44.1-34.89)/0.03
