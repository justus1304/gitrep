...
\begin{align}
    a = & \qty{2.06(0.01)e-9}{\sqrt{\ampere}\per\volt}\\
    b = & \qty{2.42(0.01)e-9}{\sqrt{\ampere}}
\end{align}
...
\noindent Die Parameter der Ausgleichsgeraden der form $f(U)=a\cdot U+b$ ergeben sich zu 
\begin{align}
    a = & \qty{1.58(0.13)e-9}{\sqrt{\ampere}\per\volt}\\
    b = & \qty{0.95(0.07)e-9}{\sqrt{\ampere}}
\end{align}
Damit ergibt sich die Grenzspannung durch Regression zu 
\begin{equation}
...
\begin{align}
    a = & \qty{0.32(0.03)e-9}{\sqrt{\ampere}\per\volt}\\
    b = & \qty{0.33(0.02)e-9}{\sqrt{\ampere}}
\end{align}
Damit ergibt sich die Grenzspannung durch Regression zu 
\begin{equation}
...
\noindent Die Parameter der Ausgleichsgeraden ergeben sich zu 
\begin{align}
    a &= \qty{0.62(4)e-9}{\sqrt{\ampere}\per\volt} \\
    b &= \qty{0.34(1)e-9}{\sqrt{\ampere}}
\end{align}
Damit ergibt sich die Grenzspannung durch Regression zu 
\begin{equation}
