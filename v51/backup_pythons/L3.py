...
f_kHz, U1_out= np.genfromtxt("Daten/L3.txt", unpack=True)
f_Hz = f_kHz * 1e3
U_e = 1.05
V = U1_out/U_e

V0 = np.mean(V[:6])
print('Dritte Leerlaufverstärkung ist V3 = ', V0)
...
f_g_Hz = 10 ** log_f_g
f_g_kHz = f_g_Hz / 1000
print(f'Dritte Grenzfrequenz ist f3_g = {f_g_kHz:.2f} kHz')
# Bandbreitenprodukt
B = V0 * f_g_kHz
print(f'Dritte Bandbreite ist B3 = {B:.2f} kHz')
