...
Gleichgewichtsdruck von $p_\text{g} = \qty{0.5(0.05)}{\milli\bar}$
\begin{equation}
  m_{\qty{0.5}{\milli\bar}} = \qty{0.00280 +- 0.00002}{\milli\bar\per\second}.
\end{equation}

\begin{figure}[H]
  \includegraphics{"drehschieberLeckrate2.pdf"}
\end{figure}
\noindent Bei der zweiten Messung mit $p_\text{g} = \qty{10(4)}{\milli\bar}$ ergibt 
sich
\begin{equation}
...
\end{figure}
\noindent Bei $p_\text{g} = \qty{50(4)}{\milli\bar}$ beläuft sich der Steigungsparameter 
auf
\begin{equation}
  m_{\qty{50}{\milli\bar}} = \qty{2.11171 +- 0.00216}{\milli\bar\per\second}.
\end{equation}

\begin{figure}[H]
  \includegraphics{"drehschieberLeckrate4.pdf"}
\end{figure}
\noindent Zuletzt ergibt sich bei $p_\text{g} = \qty{105(4)}{\milli\bar}$ ein Parameter von
\begin{equation}
...
\begin{align}
    S_{\text{eff}, 0.5\,\text{mbar}}^{\text{leck}} &= (0,19 \pm 0,04)\,\si{\text{L}\per\second} \\
    S_{\text{eff}, 10\,\text{mbar}}^{\text{leck}}  &= (1,0 \pm 0,4)\,\si{\text{L}\per\second} \\
    S_{\text{eff}, 50\,\text{mbar}}^{\text{leck}}  &= (1,4 \pm 0,2)\,\si{\text{L}\per\second} \\
    S_{\text{eff}, 105\,\text{mbar}}^{\text{leck}} &= (1,25 \pm 0,13)\,\si{\text{L}\per\second}
\end{align}


\begin{table}[H]
\centering
\caption{Messwerte für die Leckratenmethode der Drehschieberpumpe bei $p_\text{g} = \qty{0,5(0.05)}{\milli\bar}$.}
\label{tab:11}
\begin{tabular}{rrr}
\toprule
...
\begin{table}[H]
  \centering
\caption{Messwerte für die Leckratenmethode der Drehschieberpumpe bei $p_\text{g} = \qty{10(4)}{\milli\bar}$.}
\label{tab:12} 
\begin{tabular}{rrr}
\toprule
Zeit / s & Druck / mbar & Fehler / mbar \\
...
\begin{table}[H]
  \centering
\caption{Messwerte für die Leckratenmethode der Drehschieberpumpe bei $p_\text{g} = \qty{50(4)}{\milli\bar}$.}
\label{tab:13} 
\begin{tabular}{rrr}
\toprule
Zeit / s & Druck / mbar & Fehler / mbar \\
...
\begin{table}[htbp]
\centering
\caption{Messwerte und gemittelte Drücke für die Leckratenmethode der Drehschieberpumpe bei $p_{\text{g}} = \qty{105(4)}{}$.}
\label{tab:14}
\begin{tabular}{cccc}
\toprule
