...
\begin{align}
    S_\text{eff1}^\text{eva} =& \qty{4.9+-0.5}{m^3/h} = \qty{1.36+-0.14}{\liter\per\second}, \\
    S_\text{eff2}^\text{eva} =& \qty{1.71+-0.17}{m^3/h} = \qty{0.47+-0.05}{\liter\per\second}, \\
    S_\text{eff3}^\text{eva} =& \qty{0.70+-0.07}{m^3/h} = \qty{0.19+-0.2}{\liter\per\second}.
\end{align}
...
in einem Bereich von $\qty{4.6}{m^3/h}$ bis $\qty{5.5}{m^3/h}$. Der Wert für 
...
\vspace{0.5em}
\\
Zusätzlich bestätigen die Leckratenmessungen diesen Befund: Bei $\qty{50}{mbar}$
ergibt sich $S_\text{eff}^\text{leck} = \qty{5.1+-0.5}{m^3/h}$, was in
Übereinstimmung mit $S_\text{eff1}^\text{eva}$ steht, während bei $\qty{0.5}{mbar}$
nur noch $\qty{0.68+-0.07}{m^3/h}$ gemessen werden, kompatibel mit 
$S_\text{eff3}^\text{eva}$. Die beiden unabhängigen Methoden 
...
ergaben sich das effektive Saugvermögen bei der Evakuierungsmessung als
\begin{equation}
    S_\text{eff}^\text{Eva} = \qty{15.4+-1.6}{\liter\per\second}.
\end{equation}
Laut Hersteller sollte ein Vermögen von $\qty{77}{\liter\per\second}$ erreicht 
werden können, solang Stickstoff mit der Pumpe gefördert werden soll. In diesem 
...
\vspace{0.5em}
\\
Bessere Ergebnisse liefern die Messungen mittels Leckratenmethode, welche bei 
einem Druck von $p_g = \qty{56.96e-5}{\milli\bar}$ bereits ein Saugvermögen 
von mehr als $\qty{40}{\liter\per\second}$ ergaben. Insgesamt liegt die Abweichung 
noch bei knapp 44.1 bis 63.4\%. Ein Großteil der Abweichungen ist auf die
