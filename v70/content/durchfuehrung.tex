...
Python-Skript gestartet und kurz darauf V5 geschlossen, sodass die Röhre evakuiert 
...
durchgeführt. Es wird der Druckunterschied zwischen den beiden Sensoren D1 und D2 
berechnet und durch Mittelung das effektive Saugvermögen bestimmt.
...
$\approx \qty{1000}{\milli\bar}$ erreicht ist. Anschließend werden V4 und V5 geschlossen
und das Python-Skript zur Datenerfassung kann gestartet werden. Zum Zeitpunkt
$t=0$ wird das Absperrventil V1 geöffnet. Der Druckabfall wird einmal für 
600 Sekunden mit dem TPG-202 aufgezeichnet. Es stellt sich ein Druck $p_E$ ein,
welcher notiert wird.
